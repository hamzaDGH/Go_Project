...
func main() {
	...
	welcome := Welcome{"Hamza DGHOUGHI", time.Now().Format(time.Stamp)}

	//We tell Go exactly where we can find our html file. We ask Go to parse the html file (Notice
	// the relative path). We wrap it in a call to templates.Must() which handles any errors and halts if there are fatal errors
